					...
					<div class="single-view_post">
						...
						<div class="col-md-12 pb-80">
							<div class="news-inner">
								<div class="news-img">
									<img src="../resources/images/hotel/main/${hotel.st_id}.jpg" width="400" height="360" alt="">
									<div class="news-post">
								...
								<div class="news-desc">
									<h3 class="news-title">
										<a href="${pageContext.request.contextPath}/hotel/detail.do?id=${hotel.st_id}" target="_blank">${hotel.st_nm}</a>
										<i class="mdi bus-clock"></i>
									</h3>
									<p class="news_desc">${hotel.st_content}</p>
									<div class="news-action">
										<div class="read-more">
											<a href="${pageContext.request.contextPath}/hotel/detail.do?id=${hotel.st_id}" target="_blank">상세 보기</a>
										</div>
										<div class="news-share" id="cvntl_${hotel.st_id}" data-id="${hotel.st_cvntl}">
											...
											<i class="mdi mdi-${cvntl.cvntl_icon} cvntlId-${cvntl.cvntl_id}" title="${cvntl.cvntl_nm}" style="display:none;"></i>
											</c:forEach>
											<i class="mdi mdi-dots-horizontal cvntlId-dots" style="display:none;"></i>
											</c:if>
										</div>
									</div>
								</div>
