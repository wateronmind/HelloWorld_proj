...
ALTER TABLE FLIGHT_SPOT_INFO
    ADD CONSTRAINT FK_FLIGHT_SPOT_INFO_FSI_START_ FOREIGN KEY (FSI_START_PLACE, FSI_ARRIVE_PLACE, FSI_PASS1_PLACE, FSI_PASS2_PLACE)
        REFERENCES NATION_CITY (NC_CD, NC_CD, NC_CD, NC_CD)
/
...
(
    ...
    I_RENT_DAY      CHAR(10)        NOT NULL, 
    I_RETURN_DAY    CHAR(10)        NOT NULL, 
...
COMMENT ON COLUMN ITEM_INFO.I_RENT_DAY IS 'YYYY-MM-DD'
/

COMMENT ON COLUMN ITEM_INFO.I_RETURN_DAY IS 'YYYY-MM-DD'
/
...
(
    ...
    IR_CONTENT     VARCHAR2(20)    NOT NULL, 
...
ALTER TABLE ITEM_BUY_HIST
    ADD CONSTRAINT FK_ITEM_BUY_HIST_IBH_RENT_NC_N FOREIGN KEY (IBH_RENT_NC, IBH_RETURN_NC)
        REFERENCES NATION_CITY (NC_CD, NC_CD)
/
